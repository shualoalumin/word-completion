...
// .wrangler/tmp/bundle-m06RsP/checked-fetch.js
    ...
    if (url.pathname === "/test") {
      ...
      const mockBatch = {
        messages: [{
          ...
          ack: /* @__PURE__ */ __name(() => console.log("Acked"), "ack"),
          retry: /* @__PURE__ */ __name(() => console.log("Retried"), "retry")
        }]
      };
...
function buildDiscordPayload(data) {
  ...
  let color = 5793266;
  if (isSuccess) color = 5763719;
  else if (isFailed) color = 15548997;
  else if (isCancelled) color = 16705372;
...
__name(buildDiscordPayload, "buildDiscordPayload");
...
// .wrangler/tmp/bundle-m06RsP/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-m06RsP/middleware-loader.entry.ts
